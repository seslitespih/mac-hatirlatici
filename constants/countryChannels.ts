...
export const SUPPORTED_COUNTRIES: CountryInfo[] = [
  ...
  { code: 'NL', name: 'Nederland',      englishName: 'Netherlands',    flag: '🇳🇱', timezone: 'Europe/Amsterdam',        language: 'en' },
  ...
  { code: 'OM', name: 'عُمان',          englishName: 'Oman',           flag: '🇴🇲', timezone: 'Asia/Muscat',             language: 'ar' },
  // Spanish
