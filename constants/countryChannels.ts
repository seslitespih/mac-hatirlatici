...
export const COUNTRY_CHANNEL_MAP: Record<string, Record<string, string[]>> = {
  ...
  CA: {
    superlig:    [],
    lig1:        [],
    champions:   ['DAZN', 'TNT Sports'],
    europa:      ['DAZN'],
    conference:  ['DAZN'],
    premier:     ['DAZN', 'TSN'],
    laliga:      ['DAZN'],
    bundesliga:  ['DAZN'],
    seriea:      ['DAZN', 'CBS Sports'],
    ligue1:      ['DAZN'],
    saudi:       ['DAZN'],
    liganos:     ['DAZN'],
  ...
  AU: {
    ...
    wc2026:      ['SBS', 'Optus Sport', 'Channel 9'],
  ...
  NZ: {
    superlig:    [],
    lig1:        [],
    champions:   ['Sky Sport', 'Spark Sport'],
    europa:      ['Sky Sport'],
    conference:  ['Sky Sport'],
    premier:     ['Sky Sport', 'Spark Sport'],
    laliga:      ['Sky Sport'],
